...
testdata = [
    Contact(firstname="firstname1", middlename="middlename1", lastname="lastname1", nickname="nickname1", title="title1",
                      ...
                      workphone="workphone1", fax="fax1", email="email11", email2="email22",
                      email3="email33", homepage="homepage1",  address2="address21",
    ...
    Contact(firstname="firstname2", middlename="middlename2", lastname="lastname2", nickname="nickname2", title="title2",
            ...
            workphone="workphone2", fax="fax2", email="email122", email2="email222",
            email3="email332", homepage="homepage2", address2="address22",
